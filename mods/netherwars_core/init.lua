...
add_drop("livingnether:razorback", { name = "netherwars_core:nether_matter", chance = 2, min = 1, max = 3 })
add_drop("livingnether:lavawalker", { name = "netherwars_core:nether_matter", chance = 2, min = 1, max = 3 })
add_drop("livingnether:cyst", { name = "netherwars_core:nether_matter", chance = 5, min = 1, max = 2 })
add_drop("livingnether:flyingrod", { name = "netherwars_core:nether_matter", chance = 3, min = 1, max = 2 })
add_drop("livingnether:noodlemaster", { name = "netherwars_core:nether_matter", chance = 3, min = 1, max = 2 })
add_drop("livingnether:sokaarcher", { name = "netherwars_core:nether_matter", chance = 3, min = 1, max = 2 })
add_drop("livingnether:sokameele", { name = "netherwars_core:nether_matter", chance = 3, min = 1, max = 2 })
add_drop("livingnether:tardigrade", { name = "netherwars_core:nether_matter", chance = 6, min = 1, max = 2 })
...
function update_description(itemstack) 
	...
	if meta:contains("progressive_heal_level") then
		description = description ..
			string.format("\nHeal level: %.2f", meta:get_float("progressive_heal_level"))
	end
...
minetest.register_on_craft(
	function(itemstack, player, old_craft_grid, craft_inv)
		...
		if progressive_updates.heal ~= nil then
			meta:set_float("progressive_heal_level", progressive_updates.heal)
		end
